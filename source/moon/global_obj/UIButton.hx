...
class UIButton extends FlxSpriteGroup
{
	...
	function set_selected(selected:Bool):Bool
	{
		...
		{
			scale.set(0.8, 0.8);
			thisTwn = FlxTween.tween(this, {"scale.x": 1.12, "scale.y": 1.12}, 0.15, {ease: FlxEase.elasticOut});
		}
		else
			thisTwn = FlxTween.tween(this, {"scale.x": 1, "scale.y": 1}, 0.2, {ease: FlxEase.expoOut});
