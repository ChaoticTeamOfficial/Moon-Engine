 ...
 * 
 * Moon Engine is also using a specific pull request someone made to optimize the shader.
 * I tried to find the pull request but I just couldn't find it no matter what!! :(
 * if you are the person who made it, please contact me so I can credit you!
 */
class DropShadowShader extends FlxShader
{
	...
	/**
	 * The MoonSprite that the shader should get the frame data from.
