...
/**
 * The rain shader class! I just stole this from psych cuz v-slice changes the way they render runtime shaders
 * and I don't have support for that.
 * so uhh, yeahh, credits to shadow mario!!!
 * @see https://github.com/ShadowMario/FNF-PsychEngine/blob/main/source/shaders/RainShader.hx
 */
