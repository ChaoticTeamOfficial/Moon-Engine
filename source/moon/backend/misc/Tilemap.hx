...
class Tilemap
{
	...
	{
		if (atlasFrameMap.exists(id)) trace('[TILEMAP] Atlas $id already exists, overriding.');
		...
		if (!AssetManager.exclusions.contains('$atlasName.png')) AssetManager.exclusions.push('$atlasName.png');
