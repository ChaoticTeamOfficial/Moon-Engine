...
class ShowSubtitleEvent extends BaseEvent
{
    ...
    override public function getEditorFields():Array<EventFieldDef>
    {
        return [
            ...
            {name: 'size', label: 'Text Size', type: NUMBER, defaultValue: 24, min: 1, max: 200, step: 1},
            {
                name: 'boxType', label: 'Box Type', type: DROPDOWN,
                defaultValue: 'Rounded', options: ['Rounded', 'Rectangle', 'Noteskin', 'None']
            },
            {
                name: 'textfont', label: 'Text Font', type: DROPDOWN,
                defaultValue: 'vcr.ttf', options: ['vcr.ttf'] //TODO: get font list from the fonts directory
            },
            {
                name: 'outline', label: 'Outline Type', type: DROPDOWN,
                defaultValue: 'None', options: ['None', 'Shadow', 'Outline']
            },
            {
                name: 'textCol', label: 'Text Color', type: COLOR,
                defaultValue: 0xFFFFFFFF
            },
            {
                name: 'outlineCol', label: 'Outline Color', type: COLOR,
                defaultValue: 0xFFFFFFFF
            }
        ];
    }
