...
class FlxUI9SliceSprite extends FlxUISprite implements IResizable implements IFlxUIWidget
{
	...
	public override function resize(w:Float, h:Float):Void
	{
		...
		{
			if (_slice9 != null) flixel.FlxG.log.warn("Invalid 9slice array, expected a length of 4");
			_slice9 = [4, 4, 7, 7];
		}
		...
		{ // create parts
			...
			if (sectionCounter == null)
			{
				...
				for (i in 0...9)
				{
					...
					{
						case 0:
							_staticRects.get("top.left");
						case 1:
							_staticRects.get("top");
						case 2:
							_staticRects.get("top.right");
						case 3:
							_staticRects.get("left");
						case 4:
							_staticRects.get("middle");
						case 5:
							_staticRects.get("right");
						case 6:
							_staticRects.get("bottom.left");
						case 7:
							_staticRects.get("bottom");
						case 8:
							_staticRects.get("bottom.right");
						default:
							_staticRects.get("top.left");
					}
